                    ...
                    <tbody>
                        {all_products.map((e) => {
                            if (cartItems[e._id] > 0) {  
                                return (
                                    <tr key={e._id} className='border-b border-slate-900/20 text-gray-30 p-6 medium-14 text-center'>
                                        ...
                                        <td>${e.new_price}</td>
                                        <td className='h-16 w-16 bg-white'>{cartItems[e._id]}</td> {/* Updated to _id */}
                                        <td>${e.new_price * cartItems[e._id]}</td> 
                                        <td>
                                            <div className='bold-22 relative left-1/2'>
                                                <TbTrash onClick={() => removeFromCart(e._id)} /> {/* Updated to _id */}
                                            </div>
                                        </td>
                                    </tr>
                                );
